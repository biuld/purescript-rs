...
| BE-26 | Embedded standard library and user module loading | The PureScript-facing library is embedded and linked like source modules; a filesystem module loader is missing ([WASI-09](../implementation/backend/wasi-platform.md) In progress). | Partial | Replace embedding with discoverable library/module loading. |
...
| WASI platform and module loading | BE-21..BE-23, BE-26 | In progress: WASI-01..WASI-06 (console, clock, random, entry, componentization, per-service gating) Verified; WASI-07 (filesystem/arguments/environment), WASI-08 (sockets/HTTP/TLS), and WASI-09 (module loading) remain. | [WASI rows](../implementation/backend/wasi-platform.md) |
