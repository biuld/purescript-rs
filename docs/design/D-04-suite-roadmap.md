...
| Linear memory and canonical ABI | BE-11, BE-17..BE-20 | Re-baselined by DEC-10 and split: LM-02, LM-04, LM-05, ABI-01, ABI-03, ABI-06, and ABI-07 Verified; LM-01 and ABI-02 In progress for the one-memory profile and `own`/`borrow` handle drop; ABI-08 (aggregates, option/result/variant, tuples) Blocked on source types. The allocator, buffer free, and post-return moved to canonical buffer allocation. BE-19 stays `Partial`. | [LM/ABI rows](../implementation/backend/linear-memory-and-canonical-abi.md) |
...
| WASI platform and module loading | BE-21..BE-23, BE-26 | Re-baselined by DEC-10: WASI-01/02/03/04/05/06 and WASI-09 Verified; WASI-07 Blocked on ABI-08; WASI-08 and WASI-10 remain. | [WASI rows](../implementation/backend/wasi-platform.md) |
