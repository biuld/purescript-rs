...
| Linear memory and canonical ABI | BE-11, BE-17..BE-20 | Re-baselined by DEC-10: LM-05, ABI-01, ABI-06, and ABI-07 Verified; LM-01..LM-04 and ABI-02..ABI-05 In progress for GC strings, the reclaiming allocator, buffer freeing, and handles; ABI-08 (aggregates, option/result/variant, tuples, post-return) Blocked on source types. BE-19 stays `Partial`. | [LM/ABI rows](../implementation/backend/linear-memory-and-canonical-abi.md) |
