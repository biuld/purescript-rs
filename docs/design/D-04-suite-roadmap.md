...
| Linear memory and canonical ABI | BE-11, BE-17..BE-20 | In progress: LM-01..LM-05 and ABI-01..ABI-07 Verified, including narrowed/unsigned WIT integers; ABI-08 (general aggregate results, option/result/variant, non-byte lists, tuples, own/borrow) is Blocked on source types and frontend aggregate signatures. BE-19 stays `Partial`. | [LM/ABI rows](../implementation/backend/linear-memory-and-canonical-abi.md) |
| WASI platform and module loading | BE-21..BE-23, BE-26 | Topic acceptance: WASI-01..WASI-06 (console, clock, random, entry, componentization, per-service gating) and WASI-09 (user-module discovery) Verified; WASI-07 is Blocked on ABI-06; WASI-08 and WASI-10 remain. | [WASI rows](../implementation/backend/wasi-platform.md) |
