...
| WASI platform and module loading | BE-21..BE-23, BE-26 | Re-baselined by DEC-10: WASI-01/02/04/06 and WASI-09 Verified; WASI-03 and WASI-05 In progress for GC strings/byte lists; WASI-07 Blocked on ABI-08; WASI-08 remains; WASI-10 (standard library on disk) is Verified. | [WASI rows](../implementation/backend/wasi-platform.md) |
